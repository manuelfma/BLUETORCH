...
- `outputs/` — zipped upload packages.
- `scripts/` — helper script for committing the submission pack.
...
## Preview Files
- Blue Torch landing page: `prototype/blue-torch/index.html`
- Session 16 landing page: `session16/videoreport-ai/index.html`

## GitHub Repository
Target repository:

```text
https://github.com/manuelfma/BLUETORCH
```
